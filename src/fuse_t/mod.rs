...
use libc::{c_char, c_int, c_ulong, c_uint, c_void, off_t, size_t};
...
pub type FuseDirfilT =
    unsafe extern "C" fn(h: FuseDirH, name: *const c_char, type_: c_int, ino: libc::ino_t)
        -> c_int;

/// Processing function for fuse_opt_parse.
pub type FuseOptProcT = Option<
    unsafe extern "C" fn(data: *mut c_void, arg: *const c_char, key: c_int, outargs: *mut FuseArgs)
        -> c_int,
>;
...
pub struct FuseOperations {
    ...
    pub fsync:
        Option<unsafe extern "C" fn(*const c_char, c_int, *mut FuseFileInfo) -> c_int>,
    ...
    pub create:
        Option<unsafe extern "C" fn(*const c_char, mode_t, *mut FuseFileInfo) -> c_int>,
    pub ftruncate:
        Option<unsafe extern "C" fn(*const c_char, off_t, *mut FuseFileInfo) -> c_int>,
    pub fgetattr:
        Option<unsafe extern "C" fn(*const c_char, *mut stat, *mut FuseFileInfo) -> c_int>,
    pub lock: Option<
        unsafe extern "C" fn(*const c_char, *mut FuseFileInfo, c_int, *mut flock) -> c_int,
    >,
    ...
    >,
    pub flock:
        Option<unsafe extern "C" fn(*const c_char, *mut FuseFileInfo, c_int) -> c_int>,
    ...
    >,
    pub renamex:
        Option<unsafe extern "C" fn(*const c_char, *const c_char, c_uint) -> c_int>,
    pub statfs_x:
        Option<unsafe extern "C" fn(*const c_char, *mut libc::statfs) -> c_int>,
    pub setvolname: Option<unsafe extern "C" fn(*const c_char) -> c_int>,
    pub exchange:
        Option<unsafe extern "C" fn(*const c_char, *const c_char, c_ulong) -> c_int>,
    pub getxtimes: Option<
        unsafe extern "C" fn(*const c_char, *mut timespec, *mut timespec) -> c_int,
    >,
    pub setbkuptime:
        Option<unsafe extern "C" fn(*const c_char, *const timespec) -> c_int>,
    pub setchgtime:
        Option<unsafe extern "C" fn(*const c_char, *const timespec) -> c_int>,
    ...
    pub setattr_x:
        Option<unsafe extern "C" fn(*const c_char, *mut SetAttrX) -> c_int>,
    pub fsetattr_x: Option<
        unsafe extern "C" fn(*const c_char, *mut SetAttrX, *mut FuseFileInfo) -> c_int,
    >,
}
